...
#
# What it does:
#   1. Copies the exe to %LOCALAPPDATA%\PaseoLedBridge\ (stable local path,
#      independent of WSL being up).
#   2. Writes a .vbs launcher that runs it with a hidden console window
...
#      interactive session).
#   3. Registers a Scheduled Task that starts it at logon and restarts it
...
Write-Host "Installed and started. Manage via Task Scheduler > PaseoLedBridge."
